...
Defines the two-step connection dialog flow: Step 1 for selecting a database type or saved profile, and Step 2 for entering engine-specific connection parameters.
