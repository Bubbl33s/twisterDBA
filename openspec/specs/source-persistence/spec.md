...
Defines how database connection sources are persisted across sessions, including saving connected sources, auto-reconnection on startup, and source removal behavior.
