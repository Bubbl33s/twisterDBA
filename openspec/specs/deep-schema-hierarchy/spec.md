# Deep Schema Hierarchy

## Purpose

Defines the full hierarchical structure of the Database Explorer schema tree, including database nodes, object folder grouping, table detail folders, and the complete tree hierarchy from source down to individual columns, keys, foreign keys, and indexes.
